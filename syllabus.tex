...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0416}}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0223}}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0371}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.8960}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1657}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1479}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1598}}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0409}}

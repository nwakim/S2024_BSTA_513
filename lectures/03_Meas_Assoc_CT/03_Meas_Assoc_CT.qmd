...
$\widehat{p}_1 = 198/532 = `r round(p1, 4)`$, $\widehat{p}_2 = 128/1132 = `r round(p2, 4)`$
$$\widehat{OR}=\frac{\widehat{p_1}/(1-\widehat{p_1})}{\widehat{p_2}/(1-\widehat{p_2})}= \dfrac{`r round(p1, 4)`/(1-`r round(p1, 4)`)}{`r round(p2, 4)`/(1-`r round(p2, 4)`)}= `r round((p1/(1-p1))/(p2/(1-p2)), 4)`$$
...
$$\widehat{OR}=\frac{1}{4.6499}=`r round(1/4.649888, 4)`$$

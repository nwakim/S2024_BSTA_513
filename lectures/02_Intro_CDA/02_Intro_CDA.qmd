...
-   In BSTA 512/612 (linear regression), we focused on [continuous responses/outcomes]{style="color:#34AC8B; font-weight: bold;"}

    -   We included [categorical variables only as covariates]{style="color:#34AC8B; font-weight: bold;"} (aka predictors, independent variables, explanatory variables)

    -   Examples from 512/612: life expectancy (in years), IAT score (ranging from -2 to 2)

   

-   Categorical data analysis focuses on the statistical methods for [categorical responses/outcomes]{style="color:#213c96; font-weight: bold;"}
...
-   Strategies for assessing association between categorical response variable and a [one explanatory variable]{style="color:#34AC8B; font-weight: bold;"}
...
-   Statistical modeling strategies for assessing association between the categorical response variable and a [set of explanatory variables]{style="color:#213c96; font-weight: bold;"}
...
R commands with their [input]{style="color:#34AC8B"} and [output]{style="color:#213c96"}:

| R code     | What does it return?                                                                                                         |
|--------------------|----------------------------------------------------|
| `rbinom()` | returns [sample of random variables]{style="color:#213c96"} with [specified binomial distribution]{style="color:#34AC8B"}    |
| `dbinom()` | returns [probability]{style="color:#213c96"} of getting [certain number of successes]{style="color:#34AC8B"}                 |
| `pbinom()` | returns [cumulative probability]{style="color:#213c96"} of getting [certain number or less]{style="color:#34AC8B"} successes |
| `qbinom()` | returns [number of successes]{style="color:#213c96"} corresponding to [desired quantile]{style="color:#34AC8B"}              |
...
If [both variables are nominal]{style="color:#213c96; font-weight: bold;"}, a [test of general association]{style="color:#213c96; font-style: italic;"} will be sufficient
...
If [one or both variables are ordinal]{style="color:#34AC8B; font-weight: bold;"}, a [test of trend]{style="color:#34AC8B; font-style: italic;"} may be of interest
...
1.  Check that the [**expected cell counts**]{style="color:#34AC8B"} threshold is met

2.  Set the [**level of significance**]{style="color:#34AC8B"} $\alpha$

3.  Specify the [**null**]{style="color:#34AC8B"} ( $H_0$ ) and [**alternative**]{style="color:#34AC8B"} ( $H_A$ ) [**hypotheses**]{style="color:#34AC8B"}

    -   In symbols
    -   In words
    -   Alternative: one- or two-sided?

4.  Calculate the [**test statistic**]{style="color:#34AC8B"} and [**p-value**]{style="color:#34AC8B"} for Chi-squared test in R

    -   We will not discuss the test statistic's equation

5.  Write a [**conclusion**]{style="color:#34AC8B"} to the hypothesis test
...
1.  Check the [**expected cell counts**]{style="color:#34AC8B"}
...
4.  Calculate the [**test statistic**]{style="color:#34AC8B"} and [**p-value**]{style="color:#34AC8B"} for Fisher Exact test in R
...
-   Cochran-Armitage test for trend will determine if there is association between a [binary response variable]{style="color:#34AC8B; font-weight: bold;"} and an [ordinal variable with 3 or more categories]{style="color:#34AC8B; font-weight: bold;"}
...
1.  Set the [**level of significance**]{style="color:#34AC8B"} $\alpha$

2.  Specify the [**null**]{style="color:#34AC8B"} ( $H_0$ ) and [**alternative**]{style="color:#34AC8B"} ( $H_A$ ) [**hypotheses**]{style="color:#34AC8B"}

    -   In symbols
    -   In words
    -   Alternative: one- or two-sided?

3.  Calculate the [**test statistic**]{style="color:#34AC8B"} and [**p-value**]{style="color:#34AC8B"} for Cochran-Armitage test in R

    -   We will not discuss the test statistic's equation
    -   Just know it follows a Normal distribution

4.  Write a [**conclusion**]{style="color:#34AC8B"} to the hypothesis test
...
3.  Calculate the [**test statistic**]{style="color:#34AC8B"} and [**p-value**]{style="color:#34AC8B"} for Mantel-Haenszel test in R

...
Fit a new model using only CPR and INF as the predictors, including an interaction between CPR and INF. Write a sentence interpreting the odds ratio for the main effects in the model. Please include the 95% confidence interval.

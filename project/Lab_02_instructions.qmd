...
For each of the 10 predictor variables, fill out the below table. This does not need to be extensive reasoning. If you would like to present this information in another way, you may. 
...
### Fit a mulivariable logistic regression

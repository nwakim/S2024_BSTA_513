...
| 13     | Numerical Problems  | [[{{< iconify ri slideshow-fill size=30px >}}](/lectures/13_Numeric_Problems/13_Numeric_Problems.qmd)]{style="color:#f8f5f0;"} |                             [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"}                              |                                     [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"}                                      |

...
|-------------|-------------|:-------------:|:-----------------:|:-----------:|
| 12     | Assessing Model Fit | [[{{< iconify ri slideshow-fill size=30px >}}](/lectures/12_Assessing_fit/12_Assessing_fit.qmd)]{style="color:#f8f5f0;"} | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
| 13     | Assessing Model Fit |                          [{{< iconify ri slideshow-fill size=30px >}}]{style="color:#f8f5f0;"}                           | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |

...
| 4      | Measurements of Association and Agreement         | [[{{< iconify ri slideshow-fill size=30px >}}](/lectures/04_Meas_Assoc_Agree/04_Meas_Assoc_Agree.qmd)]{style="color:#f8f5f0;"} |                             [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"}                              |                                                                                            [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"}                                                                                             |

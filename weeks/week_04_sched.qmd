...
|---------------|---------------|:-------------:|:-------------:|:-------------:|
| 7      | Predictions and Visualizations in Simple Logistic Regression | [[{{< iconify ri slideshow-fill size=30px >}}](/lectures/07_Pred_Viz/07_Pred_Viz.qmd)]{style="color:#f8f5f0;"} | [[{{< iconify pepicons-pop pen-circle-filled size=29px >}}](/lectures/07_Pred_Viz/07_Pred_Viz_notes.pdf)]{style="color:#f8f5f0;"} | [[{{< iconify mdi video size=34px >}}]({{< iconify ri slideshow-fill size=30px >})]{style="color:#f8f5f0;"} |

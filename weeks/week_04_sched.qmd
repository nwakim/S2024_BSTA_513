...
| 8      | Interpretations and Visualizations of Odds Ratios            | [[{{< iconify ri slideshow-fill size=30px >}}](/lectures/08_Interpretations_SLR/08_Interpretations_SLR.qmd)]{style="color:#f8f5f0;"} |                        [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"}                         |                                  [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"}                                  |

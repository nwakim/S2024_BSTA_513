...
| 6      | Tests for GLMs using Likelihood function |          [[{{< iconify ri slideshow-fill size=30px >}}](/lectures/06_Tests_GLMs/06_Tests_GLMs.qmd)]{style="color:#f8f5f0;"}          |                                   [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"}                                    |                                     [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"}                                      |

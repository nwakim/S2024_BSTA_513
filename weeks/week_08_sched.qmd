...
| 15     | Model Building    |    [[{{< iconify ri slideshow-fill size=30px >}}](/lectures/15_Model_building/15_Model_Building.qmd)]{style="color:#f8f5f0;"}    |                                 [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"}                                  |                                     [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"}                                      |
